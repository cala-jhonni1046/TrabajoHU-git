...
@section('title', 'Inicio | Jonatan Cala')

@section('content')

<!-- ==========================================
     HERO SECTION (Sección de inicio/portada)
     Primera impresión del sitio: foto, nombre, cargo y botones
     ========================================== -->
       ...
       <div class="container hero__inner">
         ...
         <div class="hero__content">
           ...
           <div class="hero__actions">
             ...
             <a href="{{ route('proyectos') }}" class="btn btn--outline">
