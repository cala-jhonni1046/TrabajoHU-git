<!-- ════════════════════════════════════════════
     SECCIÓN: SOBRE MÍ
     ════════════════════════════════════════════ -->
<div id="sobremi" class="scroll-target" data-section data-section-label="Sobre mí">
...
<div class="section__header reveal">
         ...
         <div class="about__grid" data-group>
           <!-- Tarjeta 1: Desarrollo Full Stack -->
           <div class="about__card reveal card-spotlight">
...
<!-- ─── Bloque: EDUCACIÓN (dentro de Sobre mí) ─── -->
...
<div class="section__header reveal">
         ...
         <div class="education__grid" data-group>
 
           <!-- Educación 1: Carrera universitaria -->
           <div class="edu-card reveal card-spotlight">
